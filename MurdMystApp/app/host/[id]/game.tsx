...
export default function GameDashboard() {
    ...
    const sendCharacterSMS = async (guestId: string, characterName: string) => {
        ...
        // Using custom scheme for Expo Go testing
        // For production: switch to https://murdmyst.app with universal links
        const characterLink = `murdmystapp://party/${id}/guest/${guestId}`;
